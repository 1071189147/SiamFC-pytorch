...
def main(video_dir, gpu_id, model_path):
    ...
    filenames = sorted(glob.glob(os.path.join(video_dir, "*.bmp")),
...
if __name__ == "__main__":
    # Fire(main)
    # the abs-path of your video sadas
    video_dir = '11_27_11_14_49//'
    gpu_id = 3
    model_path = 'models/siamfc_pretrained.pth' #siamfc_pretrained.pth
